  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 ">
        ...
        <p className="dark:text-white text-sm text-center opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-2  font-medium group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-1 transition duration-200">
          {des}
        </p>
      </div>
    </div>
