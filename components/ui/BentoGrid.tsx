      ...
      <div className={`${id === 6 && "flex justify-center "} h-full     `}>
        ...
        { id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute  z-50 text-center flex items-center justify-center text-white font-bold   " ></div>
          </BackgroundGradientAnimation>
        )}
        <div
          className={cn(  
            titleClassName,
            "transition duration-200 group-hover/bento:translate-x-2 position-relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
          <div 
